...
const activity = [
  ...
  },
  {
    ...
    assigned: { name: 'John Doe', href: '#' },
    summary:
      'Agent confirmed he received an email with the portal link, and he confirmed he uploaded the policy confirmation.',
          ...
          <div className="mt-8 grid grid-cols-1 items-center gap-6 lg:mt-16 lg:grid-cols-2 lg:gap-8">
            ...
            <div className="order-1 lg:order-1">
              ...
              <p className="mt-3 text-base text-gray-600">
                Saturn tracks policy requirements per loan, ingests and validates insurance certificates, and runs
                AI-driven outreach to brokers and borrowers until compliant—while preserving a full audit trail.
              </p>

              {/* CTA Section with Button */}
              <div className="mt-4">
                <DemoButton className="w-full py-3 text-sm">Request a demo</DemoButton>
              </div>
                ...
                <div className="mx-auto w-full max-w-5xl rounded-xl border border-gray-200 bg-white p-4 shadow-2xl lg:p-6">
                                  ...
                                  {activityItem.type === 'planned' ? (
                                    <>
                                      <div>
                                        <div className="relative px-1">
                                          <div className="flex size-8 items-center justify-center rounded-full border-2 border-dashed border-blue-300 bg-gray-100 ring-8 ring-white">
                                            <svg
                                      ...
                                      <div className="min-w-0 flex-1 py-1.5">
                                        ...
                                        <div className="mt-2 flex space-x-2">
                                          <button className="inline-flex items-center gap-x-1.5 rounded-md border border-blue-300 bg-blue-100 px-3 py-1.5 text-xs font-medium text-blue-700 hover:bg-blue-200">
                                            <svg className="h-3 w-3" fill="currentColor" viewBox="0 0 20 20">
                                              <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                            </svg>
                                            Planned Action
                                          </button>
                                          <button className="inline-flex items-center gap-x-1.5 rounded-md border border-gray-300 bg-white px-3 py-1.5 text-xs font-medium text-gray-600 hover:bg-gray-50">
                                        ...
                                        <div className="mt-2 text-sm text-gray-700">
                                          <p>
                                            {activityItem.comment?.includes('policy #4782') ? (
                                              <>
                                                We need to get the updated policy because the one currently on file is
                                                expired. @AI call the agent about his{' '}
                                                <div className="inline-flex items-center gap-x-1.5 rounded-full border border-blue-200 bg-gray-50 px-2 py-1 text-xs font-medium">
                                                  <svg
                                    ...
                                    <>
                                      ...
                                      <div className="min-w-0 flex-1 py-1.5">
                                        ...
                                        <div className="mt-2 flex items-center space-x-2">
                                          <button className="inline-flex items-center gap-x-1.5 rounded-md border border-gray-300 bg-gray-100 px-2 py-1 text-xs font-medium text-gray-600 hover:bg-gray-200">
                                    ...
                                    <>
                                      ...
                                      <div className="min-w-0 flex-1 py-1.5">
                                        ...
                                        <div className="mt-2">
                                          <div className="inline-flex items-center rounded-lg border border-gray-300 bg-white px-3 py-2">
                                            <div className="mr-3 rounded bg-red-600 px-2 py-1 text-xs font-medium text-white">
                                              PDF
                                            </div>
                                            <span className="mr-3 text-sm font-medium text-gray-900">
                                              {activityItem.fileName}
                                            </span>
                  ...
                  {activeTab === 'overview' && (
                    <div className="max-h-64 overflow-y-auto lg:max-h-96">
                      ...
                      {/* Recent Activity */}
                      <div className="mb-3">
                        <h4 className="mb-2 text-xs font-semibold text-gray-900">Recent Activity</h4>
                        <AnimatedNotificationCard />
                      </div>

                      {/* Contacts section */}
                      <div className="mb-4">
                        <h4 className="mb-2 text-xs font-semibold text-gray-900">Contacts</h4>
                        <div className="grid grid-cols-2 gap-2">
                          ...
                          <div className="rounded border border-gray-200 p-2 text-xs">
                            <div className="mb-1 flex items-center space-x-2">
                              ...
                              <Badge variant="orange" icon={User}>
                                Insurance Agent
                              </Badge>
                            </div>
                            <div className="text-gray-600">
                      ...
                      <div>
                        ...
                        <div className="overflow-hidden rounded-lg border border-gray-200">
                          ...
                          <div className="border-b border-gray-200 bg-red-50 px-4 py-3 hover:bg-red-100">
                            <div
                            ...
                            >
                              ...
                              <div>
                                <div className="inline-flex items-center rounded border border-red-500 px-2 py-1 text-xs font-medium">
                                  <div className="mr-2 rounded bg-red-600 px-1 py-0.5 text-white">PDF</div>
                                  <span className="text-gray-900">Policy_123123</span>
                                  <XCircle className="ml-2 h-3 w-3 text-red-500" />
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="border-b border-gray-200 bg-green-50 px-4 py-3 hover:bg-green-100">
                            <div
                              className="grid grid-cols-5 items-center gap-4 text-sm"
                              style={{
                                gridTemplateColumns: '1fr 1fr 1fr 1.5fr 2fr',
                            ...
                            >
                              ...
                              <div>
                                <div className="inline-flex items-center rounded border border-green-500 px-2 py-1 text-xs font-medium">
                                  <div className="mr-2 rounded bg-green-600 px-1 py-0.5 text-white">PDF</div>
                                  <span className="text-gray-900">Policy_123123</span>
                          ...
                          <div className="bg-green-50 px-4 py-3 hover:bg-green-100">
                            <div
                              className="grid grid-cols-5 items-center gap-4 text-sm"
                              style={{
                                gridTemplateColumns: '1fr 1fr 1fr 1.5fr 2fr',
