...
const products = [
  {
    ...
    description: 'Automatically ingest and validate insurance certificates',
    href: '#',
    icon: ChartPieIcon,
  },
  {
    name: 'Compliance Tracking',
    description: 'Track policy requirements and compliance status',
    href: '#',
    icon: CursorArrowRaysIcon,
  },
  {
    name: 'AI Outreach',
    description: 'Automated multi-channel communications',
    href: '#',
    icon: FingerPrintIcon,
  },
  {
    name: 'Audit Trail',
    description: 'Complete compliance history and reporting',
    href: '#',
    icon: SquaresPlusIcon,
  },
  {
    name: 'Validation Engine',
    description: 'Smart document validation against rules',
    href: '#',
    icon: ArrowPathIcon,
  },
]
    ...
    <header className="absolute left-0 right-0 top-0 z-50 bg-transparent">
      <nav aria-label="Global" className="mx-auto flex h-20 max-w-7xl items-center justify-between p-6 lg:px-8">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
                ...
                {products.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-auto">
                      <a href="#features" className="block scroll-smooth font-semibold text-black">
                        {item.name}
          ...
          <a href="#showcase" className="scroll-smooth text-sm/6 font-semibold text-black">
            Features
          </a>
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <DemoButton className="px-6 py-2 text-sm">Request a demo</DemoButton>
        </div>
      </nav>
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                ...
                <a
                  href="#showcase"
                  className="-mx-3 block scroll-smooth rounded-lg px-3 py-2 text-base/7 font-semibold text-gray-900 hover:bg-gray-50"
                >
                  Features
                </a>
                <a
              ...
              <div className="py-6">
                <DemoButton className="w-full px-3.5 py-2.5 text-sm">Request a demo</DemoButton>
              </div>
            </div>
          </div>
        </DialogPanel>
