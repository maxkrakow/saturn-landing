...
const FEATURES: Feature[] = [
  {
    ...
    description: 'Texts, emails, and calls trigger automatically; docs are checked for accuracy and compliance.',
    media: {
      type: 'image',
      src: '/preview-renewal.png',
      alt: 'Renewal flow preview',
    },
  },
  {
    id: 'ocr',
    ...
    description: 'We flag missing endorsements, wrong dates, and limits—then follow up with broker + borrower.',
  ...
  },
  {
    ...
    description: "See every pending cert, escalations, and aging items—so you're always audit-ready.",
    media: {
      type: 'video',
      src: '/preview-dashboard.mp4',
        ...
        <div className="grid gap-10 md:gap-12 lg:grid-cols-2 lg:items-start">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-3 max-w-prose text-slate-600">
              Pick a feature to see it in action. Everything is built to layer on top of your current system with
              minimal lift.
            </p>
                    ...
                    <button
                      ...
                      className={[
                        ...
                        isActive
                          ...
                          : 'cursor-pointer border-slate-200 hover:border-slate-300 hover:bg-white',
                      ].join(' ')}
                    >
                        ...
                        <div className="flex items-center gap-3">
                          <span
                            className={[
                              ...
                              isActive ? 'bg-sky-500' : 'bg-slate-300 group-hover:bg-slate-400',
                            ].join(' ')}
                          />
                          <span
                            className={[
