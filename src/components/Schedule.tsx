      ...
      {day.timeSlots.map((timeSlot, timeSlotIndex) => (
        ...
        >
          ...
          <p className="mt-1 font-mono text-sm text-slate-500">
            ...
            <time dateTime={`${day.dateTime}T${timeSlot.end}-08:00`}>{timeSlot.end}</time> PST
          </p>
        </li>
      ))}
    </ol>
      ...
      <Container className="relative z-10">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-4xl lg:pr-24">
          ...
          <p className="font-display mt-4 text-2xl tracking-tight text-blue-900">
            The worst people in our industry giving the best talks you’ve ever seen. Nothing will be recorded and every
